...
export default function Migration() {
  ...
  return (
    <section
      id="migration"
      className="py-20 sm:py-32 bg-gradient-to-r from-red-700/5 via-background to-red-700/5 relative overflow-hidden"
    >
      {/* Animated Background */}
      <div
        className="absolute top-0 left-1/2 w-96 h-96 bg-red-700/10 rounded-full blur-3xl animate-float"
        ...
        <div className="space-y-16">
          ...
          >
            <h2 className="text-3xl font-heading font-extrabold sm:text-4xl lg:text-5xl text-foreground text-balance">
              <span className="text-red-700">Migration Simplifiée</span> en 3
              étapes
            </h2>
            <p className="text-lg text-foreground/70 max-w-3xl leading-relaxed">
              ...
              composant <span className="font-bold text-red-700">*172#</span>.
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                <Link
                  href="/form"
                  className="group relative w-full sm:w-auto bg-gradient-to-r from-red-700 to-red-700/80 text-red-700-foreground px-8 py-4 rounded-lg font-bold text-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-red-700/50 transform hover:scale-105"
                >
            ...
            >
              <div className="relative">
                ...
                <div className="hidden md:block absolute top-1/2 left-0 right-0 h-1 transform -translate-y-1/2 z-0">
                  <div className="flex-1 h-full bg-gradient-to-r from-transparent via-red-700/30 to-transparent"></div>
                </div>
                  ...
                  {migrationSteps.map((step, idx) => (
                    ...
                    >
                      <div className="space-y-6 relative md:w-full ">
                        {/* Card Background */}
                        <div className="absolute inset-0 bg-gradient-to-br from-red-700/10 to-red-700/5 rounded-2xl blur-xl group-hover:from-red-700/20 group-hover:to-red-700/10 transition-all duration-300"></div>

                        {/* Card Content */}
                        <div className="relative space-y-4 p-6 rounded-2xl border border-red-700/20 group-hover:border-red-700/50 transition-all duration-300">
                          <div className="inline-flex items-center text-white justify-center w-24 h-24 rounded-full bg-gradient-to-br from-red-700 to-red-700/80 text-4xl font-bold shadow-lg shadow-red-700/30 group-hover:scale-110 group-hover:shadow-red-700/50 transition-all duration-300">
                            {step.number}
                          </div>

                          <div className="space-y-3 pt-4">
                            <h3 className="text-2xl font-bold text-foreground group-hover:text-red-700 transition-colors">
                              {step.title}
                            </h3>
                          ...
                          {idx < migrationSteps.length - 1 && (
                            <div className="md:hidden pt-4">
                              <ArrowRight className="w-6 h-6 text-red-700/50 rotate-90" />
                            </div>
                          )}
                        </div>
                      </div>
